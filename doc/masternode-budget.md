...
Izzy now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<izzy_address\> \<monthly_payment_izzy\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ IZZY, _12_ times over the course of a year totaling _24000_ IZZY.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<izzy_address\> \<monthly_payment_izzy\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` IZZY.
 ...
 * vote-many          - Vote on a Izzy initiative
 * vote-alias         - Vote on a Izzy initiative
 * vote               - Vote on a Izzy initiative/budget
