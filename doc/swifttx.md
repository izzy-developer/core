...
This mechanism has been integrated into Bitcore-Node-IZZY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/izzy-developer/insight-api-izzy#web-socket-api](https://github.com/izzy-developer/insight-api-izzy#web-socket-api) 
* API: [https://github.com/izzy-developer/insight-api-izzy#swifttx-transactions](https://github.com/izzy-developer/insight-api-izzy#swifttx-transactions) 
...
By default, the IZZY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IZZY Core daemon:
