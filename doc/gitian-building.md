...
*Setup instructions for a Gitian build of Izzy Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Izzy
...
- [Building Izzy Core](#building-Izzy-core)
...
For example, to connect as `root` from a Linux command prompt use
    ...
    inizzydual files in /usr/share/doc/*/copyright.
...
Clone the git repositories for Izzy Core and Gitian.
...
in the Izzy Core repository under 'Fetch and create inputs' to install sources which require
...
To build Izzy Core (for Linux, OS X and Windows):
...
`./bin/gbuild --commit izzy=${COMMIT} ../Izzy/izzy/contrib/gitian-descriptors/gitian-linux.yml`
`./bin/gbuild --commit izzy=${COMMIT} ../Izzy/izzy/contrib/gitian-descriptors/gitian-osx.yml`
`./bin/gbuild --commit izzy=${COMMIT} ../Izzy/izzy/contrib/gitian-descriptors/gitian-win.yml`

instead of `${COMMIT}` you can specify any branch or tag, for instance: `izzy=master`
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Izzy/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/izzy-developer/Izzy
...
For example:
```bash
URL=https://github.com/crowning-/Izzy.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit izzy=${COMMIT} --url Izzy=${URL} ../Izzy/izzy/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit izzy=${COMMIT} --url Izzy=${URL} ../Izzy/izzy/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit izzy=${COMMIT} --url Izzy=${URL} ../Izzy/izzy/contrib/gitian-descriptors/gitian-osx.yml
```
