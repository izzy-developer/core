...
In order to support loading of multiple wallets in izzy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is izzy.cpp.
...
Changes to izzy.cpp
----------------------
izzy.cpp is the entry point into izzy-qt, and as such, will require some minor modifications to provide hooks for
