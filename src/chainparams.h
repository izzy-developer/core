...
// Copyright (c) 2015-2017 The IZZY Core developers
 ...
 * IZZY system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Used if GenerateIzzy is called with a negative number of threads */
