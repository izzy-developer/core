...
// Copyright (c) 2018 The Izzy developers
...
#else
//! These need to be macros, as clientversion.cpp's and izzy*-res.rc's voodoo requires it
...
#define COPYRIGHT_STR "2009-" STRINGIZE(COPYRIGHT_YEAR) " The Bitcoin Core Developers, 2014-" STRINGIZE(COPYRIGHT_YEAR) " The Dash Core Developers, 2015-" STRINGIZE(COPYRIGHT_YEAR) " The PIVX Developers, 2015-" STRINGIZE(COPYRIGHT_YEAR) " The IZZY Core Developers"

/**
 * izzyd-res.rc includes this file, but it cannot cope with real c++ code.
...
* for both izzyd and izzy-qt, to make it harder for attackers to
...
const std::string CLIENT_NAME_STR("IZZY Core");
