...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 ||settings.ParameterIsSet("-?") ||settings.ParameterIsSet("-help")) {
        ...
        std::string strUsage = translate("Izzy Core izzy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               translate("Usage:") + "\n" +
                               "  izzy-tx [options] <hex-tx> [commands]  " + translate("Update hex-encoded izzy transaction") + "\n" +
                               "  izzy-tx [options] -create [commands]   " + translate("Create hex-encoded izzy transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded izzy transaction
