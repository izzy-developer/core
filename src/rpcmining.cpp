...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    else // Not -regtest: start generate thread, return immediately
    {
        ...
        GenerateIzzy(fGenerate, pwalletMain, nGenProcLimit);
    }
...
// NOTE: Unlike wallet RPC (which use IZZY values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
{
    throw std::runtime_error("getblocktemplate has been removed, use izzyd for staking");
}
