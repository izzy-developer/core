Contributing to IZZY Core
============================

The IZZY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IZZY Core project, and is not to be
confused with overall IZZY Network Protocol consensus changes.

Whether a pull request is merged into IZZY Core rests with the project merge
...
Patches that change IZZY consensus rules are considerably more involved than
...
Where a patch set proposes to change the IZZY consensus, it must have been
...
The project leader is the release manager for each IZZY Core release.
