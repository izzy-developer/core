...
RESOURCES += src/qt/izzy.qrc src/qt/izzy_locale.qrc

TRANSLATIONS += src/qt/locale/izzy_bg.ts \
                src/qt/locale/izzy_de.ts \
                src/qt/locale/izzy_en.ts \
                src/qt/locale/izzy_es.ts \
                src/qt/locale/izzy_fi.ts \
                src/qt/locale/izzy_fr.ts \
                src/qt/locale/izzy_it.ts \
                src/qt/locale/izzy_ja.ts \
                src/qt/locale/izzy_pl.ts \
                src/qt/locale/izzy_pt.ts \
                src/qt/locale/izzy_ru.ts \
                src/qt/locale/izzy_sk.ts \
                src/qt/locale/izzy_sv.ts \
                src/qt/locale/izzy_vi.ts \
                src/qt/locale/izzy_zh_CN.ts \
                src/qt/locale/izzy_zh_TW.ts
